    ...
    <script>
        ...
        function addCategory(){
            open_modal("addNewCategory",{
                title:"<?php echo __("admin/products/add-addon-category-modal-title"); ?>"
            });
        }
        ...
        function deleteCategory(id,name){
            var content = "<?php echo __("admin/products/addon-category-delete-are-youu-sure"); ?>";
            $("#confirmModal_text").html(content.replace("{name}",name));

            open_modal("ConfirmModal",{
                title:"<?php echo __("admin/products/delete-modal-addon-category-title"); ?>"
            });
            ...
            $("#delete_ok").click(function(){
                var request = MioAjax({
                    action: "<?php echo $links["controller"]; ?>",
                    method: "POST",
                    data: {operation:"delete_addon_category",id:id}
                },true,true);
...
<div id="addNewCategory" style="display: none;">
    <div class="padding20">
        ...
        <form action="<?php echo $links["controller"]; ?>" method="post" id="addNewForm">
            <input type="hidden" name="operation" value="add_new_addon_category">
            ...
            <div style="float:right;margin-top:10px;" class="guncellebtn yuzde30">
                <a class="yesilbtn gonderbtn" id="addNewForm_submit" href="javascript:void(0);"><?php echo __("admin/products/new-addon-category-button"); ?></a>
            </div>
            <div class="clear"></div>
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1>
                    <strong><?php echo __("admin/products/page-addon-categories"); ?></strong>
            ...
            <?php if($privOperation): ?>
                <a href="javascript:addCategory();void 0;" class="green lbtn"><i class="fa fa-plus"></i> <?php echo __("admin/products/add-new-addon-category"); ?></a>
            <?php endif; ?>

            <?php if($privOperation): ?>
                <a href="<?php echo $links["add"]; ?>" class="blue lbtn"><i class="fa fa-plus"></i> <?php echo __("admin/products/add-new-addon"); ?></a>
            <?php endif; ?>
            ...
            <table width="100%" id="datatable" class="table table-striped table-borderedx table-condensed nowrap">
                ...
                <tr>
                    <th align="left">#</th>
                    <th align="left"><?php echo __("admin/products/addon-category-list-name"); ?></th>
                    <th align="center"></th>
                </tr>
                </thead>
