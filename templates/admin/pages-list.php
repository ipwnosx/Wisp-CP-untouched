    ...
    <script>
        ...
        function deletePage(id,name){
            ...
            open_modal("ConfirmModal",{
                title:"<?php echo __("admin/manage-website/delete-page-title"); ?>"
            });
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1>
                    <strong><?php echo __("admin/manage-website/page-pages-list");?></strong>
                </h1>
            ...
            <?php if($privOperation): ?>
                <div style="float: left;">
                    <a class="lbtn" href="<?php echo $links["contracts"]; ?>"><?php echo __("admin/manage-website/button-contracts"); ?></a>
                </div>
                <div style="float: right;">
                    <a class="green lbtn" href="<?php echo $links["create"]; ?>">+ <?php echo __("admin/manage-website/button-add-normal-page"); ?></a>
                </div>
            <?php endif; ?>
