            ...
            <div class="reports">
                ...
                <div class="reports-content">
                    ...
                    <div class="reportsinfotitle">
                        <?php echo __("admin/wanalytics/report-note-23"); ?>
                    </div>

                    <div class="reportfoundinfo">
                        <h4>
                            <?php
                                if($result_total_type == "minus")
                                    echo __("admin/wanalytics/report-note-25",[
                                        '{total}'       => $result_total,
                                        '{count}'       => $result_count,
                                    ...
                                    echo __("admin/wanalytics/report-note-24",[
                                        '{total}'       => $result_total,
                                        '{count}'       => $result_count,
                                        '{from_date}'   => DateManager::format(Config::get("options/date-format"),$filter_from),
                                        '{to_date}'     => DateManager::format(Config::get("options/date-format"),$filter_to),
                    ...
                    <table width="100%" id="list_table" class="table table-striped table-borderedx table-condensed nowrap">
                        ...
                        <tr>
                            ...
                            <th align="center" data-orderable="false"><?php echo __("admin/wanalytics/list-table-income"); ?></th>
                            <th align="center" data-orderable="false"><?php echo __("admin/wanalytics/list-table-expense"); ?></th>
                            <th align="center" data-orderable="false"><?php echo __("admin/wanalytics/list-table-closing"); ?></th>
                        </tr>
                        </thead>
                            ...
                            if(isset($list) && $list){
                                foreach($list AS $k=>$row){
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><?php echo $row["income_format"]; ?></td>
                                        <td align="center"><?php echo $row["expense_format"]; ?></td>
                                        <td align="center">
                                            <?php
                                                if($row["total"] < 0){
                                                    echo '<span style="color: #f44336;">'.$row["total_format"].'</span>';
                                                }elseif($row["total"]>0){
                                                    echo '<span style="color: #81c04e;">'.$row["total_format"].'</span>';
                                                }else
                                                    echo $row["total_format"];
