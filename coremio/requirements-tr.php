...
<div id="wrapper">
    ...
    <div style="padding:25px;">
        ...
        <div class="notice">
            ...
            Sistemin sorunsuz çalışabilmesi için aşağıdaki gereksinimlerin tam ve eksiksiz olması gerekmektedir. Belirtilen özelliklerden herhangi biri bulunmuyorsa, hosting sağlayıcınızdan destek almanızı öneririz.
            </div>
        </div>
        ...
        <?php
            ...
            if(isset($_GET["checking"]) && $_GET["checking"])
            {
                if($conformity)
                {
                    ...
                    <div style="margin-top:30px;margin-bottom:70px;text-align:center;">
                        ...
                        <h2 style="font-weight:bold;color: #4CAF50;">Herşey Yolunda!</h2>
                        <h3>Sunucunuz gereksinimleri karşılıyor.</h3>
                    </div>
                    <?php
                }
                else
                {
                    ...
                    if(!$ioncube){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                ...
                                <span style="font-size:14px;">(Ioncube güncel değil veya hiç aktif değil.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$php){
                        ...
                        <div class="yuzde70">
                                ...
                                <span style="font-size:14px;">(PHP Sürümünüz <strong>7.2</strong> veya <strong>Üstü</strong> olmalıdır.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$phpinfo){
                        ...
                        <div class="yuzde70">
                                ...
                                <span style="font-size:14px;">(Bu fonksiyon kapalı olduğundan sistem bilgileri okunamamaktadır.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$curl){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                <i style="color:#DB1E1E;font-size:20px;" class="fa fa-ban" aria-hidden="true"></i>
                                <span style="font-size:14px;">(cURL kütüphanesi aktif olmalıdır.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$pdo){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                <i style="color:#DB1E1E;font-size:20px;" class="fa fa-ban" aria-hidden="true"></i>
                                <span style="font-size:14px;">(<a href='http://php.net/manual/en/book.pdo.php' target='_blank'>PDO ve MySQL Sürücüsü</a> Aktif olmalıdır.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$zip){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                <i style="color:#DB1E1E;font-size:20px;" class="fa fa-ban" aria-hidden="true"></i>
                                <span style="font-size:14px;">(<a href='http://php.net/manual/en/class.ziparchive.php' target='_blank'>ZipArchive</a> Aktif olmalıdır.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$mbstring){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                <i style="color:#DB1E1E;font-size:20px;" class="fa fa-ban" aria-hidden="true"></i>
                                <span style="font-size:14px;">(<a href='http://php.net/manual/en/book.mbstring.php' target='_blank'>Mbstring</a> Aktif olmalıdır.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$openssl){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                <i style="color:#DB1E1E;font-size:20px;" class="fa fa-ban" aria-hidden="true"></i>
                                <span style="font-size:14px;">(<a href='http://php.net/manual/en/book.openssl.php' target='_blank'>OpenSSL</a> Aktif olmalıdır.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$gd){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                <i style="color:#DB1E1E;font-size:20px;" class="fa fa-ban" aria-hidden="true"></i>
                                <span style="font-size:14px;">(<a href='http://php.net/manual/en/book.image.php' target='_blank'>GD Library</a> Aktif olmalıdır.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$intl){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                <i style="color:#DB1E1E;font-size:20px;" class="fa fa-ban" aria-hidden="true"></i>
                                <span style="font-size:14px;">(<a href='http://php.net/manual/en/book.intl.php' target='_blank'>Intl Library</a> Aktif olmalıdır.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$file_get_put){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                ...
                                <span style="font-size:14px;">(Belirtilen fonksiyonları etkinleştiriniz.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$glob){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                <i style="color:#DB1E1E;font-size:20px;" class="fa fa-ban" aria-hidden="true"></i>
                                <span style="font-size:14px;">(Belirtilen fonksiyonu etkinleştiriniz.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$finfo){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                <i style="color:#DB1E1E;font-size:20px;" class="fa fa-ban" aria-hidden="true"></i>
                                <span style="font-size:14px;">(Belirtilen sınıfı etkinleştiriniz.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$memory_limit){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                ...
                                <span style="font-size:14px;">(Minimum değer: <?php echo $suggested_memory; ?>M olmalıdır.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$max_execution_time){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                ...
                                <span style="font-size:14px;">(Minimum değer: <?php echo $suggested_exe; ?> olmalıdır.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    if(!$session){
                        ...
                        <div class="formcon">
                            ...
                            <div class="yuzde70">
                                <i style="color:#DB1E1E;font-size:20px;" class="fa fa-ban" aria-hidden="true"></i>
                                <span style="font-size:14px;">(Session verisi kaydedilemiyor.)</span>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    <div class="requirementnotice">
                        <h3 style="color:#f44336"><strong>Lütfen yukarıda belirtilen eksiklikleri tamamlayınız.</strong></h3>
                    </div>

                    <div class="clear"></div>
                    
                    <div align="center">
                        <a class="button" href="">Sayfayı Yenile</a>
                    </div>
                    <?php
                }
            }
            else
            {
				...
				<h2 style="font-weight:bold;">Gereksinim Denetleyici</h2>
				<h4>Sunucu sistem gereksinimlerini kontrol edin.</h4>
				<a class="button" href="?checking=true">Kontrolü Başlat</a>
				</div>
