...
<head>
    ...
    <script>
        ...
        function deleteAddon(id,name){
            var content = "<?php echo __("admin/products/addon-delete-are-youu-sure"); ?>";
            $("#confirmModal_text").html(content.replace("{name}",name));

            open_modal("ConfirmModal",{
                title:"<?php echo __("admin/products/delete-modal-addon-title"); ?>"
            });
        ...
        function editCategory(id){
            ...
            var request = MioAjax({
                action:"<?php echo $links["controller"]; ?>",
                method:"POST",
                data:{operation:"get_addon_category",id:id},
            },true,true);
...
<div id="editCategory" style="display: none;">
    <div class="padding20">
                    ...
                    if(solve !== false){
                        if(solve.status == "error"){
                            ...
                            open_modal("editCategory",{
                                title:"<?php echo __("admin/products/edit-addon-category-modal-title"); ?>"
                            });
        ...
        <form action="<?php echo $links["controller"]; ?>" method="post" id="editForm">
            <input type="hidden" name="operation" value="edit_addon_category">
            <input type="hidden" name="id" value="0">

            <div class="formcon">
                <div class="yuzde30"><?php echo __("admin/products/add-addon-category-title"); ?></div>
                <div class="yuzde70">
            ...
            <div style="float:right;margin-top:10px;" class="guncellebtn yuzde30">
                <a class="yesilbtn gonderbtn" id="editForm_submit" href="javascript:void(0);"><?php echo __("admin/products/edit-addon-category-button"); ?></a>
            </div>
            <div class="clear"></div>
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1>
                    <strong><?php echo __("admin/products/page-addons-list"); ?></strong> (<?php echo $category["title"]; ?>)
                </h1>
                <?php
                $ui_help_link = 'https://docs.wisecp.com/en/kb/addons';
                if($ui_lang == "tr") $ui_help_link = 'https://docs.wisecp.com/tr/kb/urun-hizmet-eklentileri';
                ?>
            ...
            <?php if($privOperation): ?>
                <a href="<?php echo $links["add"]; ?>" class="green lbtn"><i class="fa fa-plus"></i> <?php echo __("admin/products/add-new-addon"); ?></a>
            <?php endif; ?>

            <a href="javascript:void(0);" onclick="editCategory(<?php echo $category["id"]; ?>);" class="blue lbtn"><i class="fa fa-edit" aria-hidden="true"></i> <?php echo __("admin/products/edit-addon-category-modal-title"); ?></a>
            ...
            <table width="100%" id="datatable" class="table table-striped table-borderedx table-condensed nowrap">
                ...
                <tr>
                    <th align="left">#</th>
                    <th align="left"><?php echo __("admin/products/addon-list-name"); ?></th>
                    <th align="center"><?php echo __("admin/products/addon-list-category"); ?></th>
                    <th align="center"><?php echo __("admin/products/addon-list-main-category"); ?></th>
                    <th align="center"><?php echo __("admin/products/addon-list-status"); ?></th>
                    <th align="center"></th>
                </tr>
                </thead>
