...
<table width="100%" border="0" cellpadding="3">
    <tr>
        ...
        <td width="70%" style="border-bottom: 1px solid #eeeeee; padding: 5px;font-family: Calibri,Arial,Helvetica,sans-serif;">
            <?php if(isset($options["creation_info"]["reseller"]) && $options["creation_info"]["reseller"]): ?>
                <a href="http://<?php echo $hostname; ?>:2086">http://<?php echo $hostname; ?>:2086</a>
            <?php else: ?>
                <a href="http://<?php echo $hostname; ?>/cp/">http://<?php echo $hostname; ?>/cp</a>
            <?php endif; ?>
        </td>
    </tr>
