    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/products/page-add-software-category"); ?></strong></h1>
            ...
            <form  enctype="multipart/form-data" action="<?php echo $links["controller"]; ?>" method="post" id="addNewForm" style="margin-top: 5px;">
                <input type="hidden" name="operation" value="add_new_software_category">
                            ...
                            <div id="lang-<?php echo $lkey; ?>" class="tabcontent">
                                ...
                                <div class="adminpagecon">
                                    ...
                                    <div class="formcon">
                                        ...
                                        <div class="yuzde70">
                                            <input name="title[<?php echo $lkey; ?>]" type="text" placeholder="<?php echo __("admin/products/add-new-category-title-ex"); ?>" onchange="check_route('<?php echo $lkey; ?>',true),seo_creator('<?php echo $lkey; ?>');" onkeyup="$('input[name=\'route[<?php echo $lkey; ?>]\']').val(convertToSlug(this.value));">
                                        </div>
                                    </div>
                                    ...
                                    <!--div class="formcon">
                                        ...
                                        <div class="yuzde70">
                                            <input name="sub_title[<?php echo $lkey; ?>]" type="text" placeholder="<?php echo __("admin/products/add-new-category-subtitle-ex")?>" onchange="seo_creator('<?php echo $lkey; ?>');">
                                        </div>
                                    </div-->
                                    ...
                                    <?php if($lang["local"]): ?>
                                        ...
                                        <div class="formcon">
                                            ...
                                            <div class="yuzde70">
                                                <input type="text" name="icon" value="" placeholder="fa fa-server">
                                                <div class="clear"></div>
                                                ...
                                                <div class="headerbgedit">
                                                    ...
                                                    <div class="headbgeditbtn">
                                                        <a href="javascript:$('#icon_image').val('').trigger('change');" class="photosil"><i class="fa fa-trash"></i></a><br/>
                                                        <a class="avatarguncelle" href="javascript:void(0);" onclick="$('#icon_image').click();" ><i class="fa fa-camera" aria-hidden="true"></i></a>
                                                    </div>
                                                    <img src="<?php echo $getIconImageDeft; ?>" width="100%" id="icon_image_preview">
                                                </div>
                                                <div class="clear"></div>
                                    ...
                                    <div class="formcon">
                                        <div class="yuzde30">
                                            <?php echo __("admin/products/add-new-category-detailed-content"); ?>
                                            <div class="clear"></div>
                                            <span class="kinfo"><?php echo __("admin/products/add-new-category-detailed-content-desc"); ?></span>
                                        </div>
                                        <div class="yuzde70">
                                            <textarea class="tinymce-1" name="content[<?php echo $lkey; ?>]" cols="" rows="3" placeholder="<?php echo __("admin/products/add-new-category-detailed-content-ex"); ?>"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="formcon">
                                        ...
                                        <div class="yuzde70">
                                            <textarea name="html-content[<?php echo $lkey; ?>]" cols="" rows="3" placeholder="<?php echo __("admin/products/add-new-category-content-ex"); ?>"></textarea>
                ...
                <div style="float:right;margin-top:10px;" class="guncellebtn yuzde30">
                    <a class="yesilbtn gonderbtn" id="addNewForm_submit" href="javascript:void(0);"><?php echo __("admin/products/new-category-button"); ?></a>
                </div>
                <div class="clear"></div>
            </form>
