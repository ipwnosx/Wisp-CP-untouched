    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/products/page-add-server-category"); ?></strong></h1>
            ...
            <form  enctype="multipart/form-data" action="<?php echo $links["controller"]; ?>" method="post" id="addNewForm" style="margin-top: 5px;">
                <input type="hidden" name="operation" value="add_new_server_category">
                                    ...
                                    <?php if($lang["local"]): ?>
                                        ...
                                        <div class="formcon">
                                            ...
                                            <div class="yuzde70">
                                                ...
                                                <input checked type="radio" class="radio-custom" name="list_template" value="1" id="list-template-1">
                                                ...
                                                <input type="radio" class="radio-custom" name="list_template" value="2" id="list-template-2">
                                            ...
                                            <div class="yuzde70">
                                                ...
                                                <div class="headerbgedit">
                                                    ...
                                                    <div class="headbgeditbtn">
                                                        <a href="javascript:$('#icon_image').val('').trigger('change');void 0;" class="photosil"><i class="fa fa-trash"></i></a><br/>
