    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/manage-website/page-pages-edit",['{title}' => $page["title"]]); ?></strong></h1>
            ...
            <form action="<?php echo $links["controller"]; ?>" method="post" id="editForm" style="margin-top: 5px;">
                <input type="hidden" name="operation" value="edit_normal_page">
                                        ...
                                        <div class="formcon">
                                            ...
                                            <div class="yuzde70">
                                                <div class="headerbgedit">
                                                    ...
                                                    <div class="headbgeditbtn">
                                                        <a href="javascript:listimg_delete();" class="photosil"><i class="fa fa-trash"></i></a><br/>
