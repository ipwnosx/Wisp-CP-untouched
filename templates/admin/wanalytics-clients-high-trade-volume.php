            ...
            <div class="reports">
                ...
                <div class="reports-content">
                    ...
                    <div class="reportsinfotitle">
                        <?php echo __("admin/wanalytics/report-note-5"); ?>
                    </div>
                    ...
                    <table width="100%" id="list_table" class="table table-striped table-borderedx table-condensed nowrap">
                        ...
                        <tr>
                            ...
                            <th align="center"><?php echo __("admin/wanalytics/list-table-trade-volume"); ?></th>
                            <th align="center"></th>
                        </tr>
                        </thead>
                            ...
                            if(isset($result) && $result){
                                foreach($result AS $k=>$row){
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><?php echo $row["trade_volume"]; ?></td>
                                        <td align="center">
