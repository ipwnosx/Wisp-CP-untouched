    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/products/page-edit-server-category",['{name}' => $cat["title"]]); ?></strong></h1>
            ...
            <form  enctype="multipart/form-data" action="<?php echo $links["controller"]; ?>" method="post" id="editForm" style="margin-top: 5px;">
                <input type="hidden" name="operation" value="edit_server_category">
                                    ...
                                    <?php if($lang["local"]): ?>
                                        ...
                                        <div class="formcon">
                                            ...
                                            <div class="yuzde70">
                                                ...
                                                <input<?php echo $list_template == 1 ? ' checked' : ''; ?> type="radio" class="radio-custom" name="list_template" value="1" id="list-template-1">
                                                ...
                                                <input<?php echo $list_template == 2 ? ' checked' : ''; ?> type="radio" class="radio-custom" name="list_template" value="2" id="list-template-2">
