...
<head>
    <?php
        ...
        $bubble_count   = AdminModel::license_errors_bubble_count();
    ?>
    ...
    <script>
        ...
        function deleteProduct(id,name){
            var content = "<?php echo __("admin/products/software-product-delete-are-youu-sure"); ?>";
            $("#confirmModal_text").html(content.replace("{name}",name));

            open_modal("ConfirmModal",{
                title:"<?php echo __("admin/products/delete-modal-software-product-title"); ?>"
            });
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1>
                    <strong><?php echo __("admin/products/page-software-list"); ?></strong>
                    <a href="<?php echo $links["software-group-redirect"]; ?>" target="_blank" class="sbtn"><i class="fa fa-external-link" aria-hidden="true"></i></a>
                </h1>
                <?php
                $ui_help_link = 'https://docs.wisecp.com/en/kbc/software';
                if($ui_lang == "tr") $ui_help_link = 'https://docs.wisecp.com/tr/kbc/yazilim';
                ?>
            ...
            <a<?php echo $bubble_count ? ' id="notifiballonalert"' : ''; ?> href="<?php echo $links["license-errors"]; ?>" style="float: right;" class="red lbtn"><i class="fa fa-exclamation-triangle"></i> <?php echo __("admin/products/software-license-errors-button"); ?>
                <?php if($bubble_count): ?>
                    (<?php echo $bubble_count; ?>)
                <?php endif; ?>
            </a>
