    ...
    <script>
        ...
        function deletePage(id,name){
            ...
            open_modal("ConfirmModal",{
                title:"<?php echo __("admin/manage-website/delete-reference-title"); ?>"
            });
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1>
                    <strong><?php echo __("admin/manage-website/page-references-list");?></strong>
                </h1>
            ...
            <?php if($privOperation): ?>
                <div style="float: left; margin-right: 5px;">
                    <a class="green lbtn" href="<?php echo $links["create"]; ?>">+ <?php echo __("admin/manage-website/button-add-reference-page"); ?></a>
                </div>
            <?php endif; ?>
