...
?>
<?php echo $LANG["text1"]; ?>;
- Panel: <?php echo $domain; ?>:<?php echo $server["port"]; ?>
- FTP Server: ftp.<?php echo $domain; ?>
...
(<?php echo Utility::text_replace($LANG["text10"]["content"],['{mail_panel_link}' => "http://webmail.".$domain]); ?>)