...
<div id="DomainNameAPI_tab">
    <ul class="modules-tabs">
        <li><a href="javascript:DomainNameAPI_open_tab(this,'detail');" data-tab="detail" class="modules-tab-item active"><?php echo $LANG["tab-detail"]; ?></a></li>
        <li><a href="javascript:DomainNameAPI_open_tab(this,'import');" data-tab="import" class="modules-tab-item"><?php echo $LANG["tab-import"]; ?></a></li>
    </ul>
    ...
    <div id="DomainNameAPI_tab-detail" class="modules-tabs-content" style="display: block">
        ...
        <form action="<?php echo Controllers::$init->getData("links")["controller"]; ?>" method="post" id="DomainNameAPISettings">
            ...
            <div style="float:left;" class="guncellebtn yuzde30"><a id="DomainNameAPI_testConnect" href="javascript:void(0);" class="lbtn"><i class="fa fa-plug" aria-hidden="true"></i> <?php echo $LANG["test-button"]; ?></a></div>

            <div style="float:right;" class="guncellebtn yuzde30"><a id="DomainNameAPI_submit" href="javascript:void(0);" class="yesilbtn gonderbtn"><?php echo $LANG["save-button"]; ?></a></div>
...
<div id="DomainNameAPI_import_tld" style="display: none;" data-izimodal-title="<?php echo $LANG["fields"]["import-tld"]; ?>">
    ...
    <div class="padding20">
        ...
        <div align="center">
            <div class="yuzde50">
                <a class="yesilbtn gonderbtn" href="javascript:void 0;" id="DomainNameAPI_import_tld_submit"><i class="fa fa-check" aria-hidden="true"></i> <?php echo ___("needs/ok"); ?></a>
            </div>
        </div>
