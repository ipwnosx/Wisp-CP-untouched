    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/products/page-edit-software-category",['{name}' => $cat["title"]]); ?></strong></h1>
            ...
            <form  enctype="multipart/form-data" action="<?php echo $links["controller"]; ?>" method="post" id="editForm" style="margin-top: 5px;">
                <input type="hidden" name="operation" value="edit_software_category">
                ...
                <div id="tab-lang"><!-- tab wrap content start -->
                    ...
                    <?php
                        ...
                        foreach($lang_list AS $lang) {
                            ...
                            $hcontent    = isset($optionsl["html-content"]) ? $optionsl["html-content"] : false;
                            ...
                            <div id="lang-<?php echo $lkey; ?>" class="tabcontent">
                                ...
                                <div class="adminpagecon">
                                    ...
                                    <div class="formcon">
                                        <div class="yuzde30"><?php echo __("admin/products/add-new-category-detailed-content"); ?></div>
                                        <div class="yuzde70">
                                            <textarea class="tinymce-1" name="content[<?php echo $lkey; ?>]" cols="" rows="3" placeholder="<?php echo __("admin/products/add-new-category-detailed-content-ex"); ?>"><?php echo $content; ?></textarea>
                                            <br><span class="kinfo"><?php echo __("admin/products/add-new-category-detailed-content-desc"); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="formcon">
                                        ...
                                        <div class="yuzde70">
                                            <textarea name="html-content[<?php echo $lkey; ?>]" cols="" rows="3" placeholder="<?php echo __("admin/products/add-new-category-content-ex"); ?>"><?php echo $hcontent; ?></textarea>
