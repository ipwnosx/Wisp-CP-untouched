...
<table width="100%" border="0" cellpadding="3">
    <tr>
        ...
        <td width="70%" style="border-bottom: 1px solid #eeeeee; padding: 5px;font-family: Calibri,Arial,Helvetica,sans-serif;">
            <a href="<?php echo $server["secure"] ? "https" : "http"; ?>://<?php echo $hostname; ?>:<?php echo $server["secure"] ? "2083" : "2082"; ?>"><?php echo $server["secure"] ? "https" : "http"; ?>://<?php echo $hostname; ?>:<?php echo $server["secure"] ? "2083" : "2082"; ?></a>
        </td>
    </tr>
