...
<head>
    <?php
        ...
        $rules_keys = $filter["rules"] ? array_keys($filter["rules"]) : [];
        if($rules_keys) $rule_last_id = max($rules_keys);

        if($filter["fields"]){
            foreach($filter["fields"] AS $l_key=> $l_fields){
                $_l_f_id = -1;

                if($l_fields){
                    $l_field_keys = array_keys($l_fields);
                    $_l_f_id = max($l_field_keys);
                }

                $field_last_id[$l_key] = $_l_f_id;
            }
        }

        $field_last_id = Utility::jencode($field_last_id);
    ...
    <script type="text/javascript">
        var rule_last_id = <?php echo $rule_last_id; ?>;
        var field_last_id = <?php echo $field_last_id; ?>;
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/users/page-edit-document-filter"); ?></strong></h1>
            ...
            <div class="adminpagecon">
                ...
                <form action="<?php echo $links["controller"]; ?>" method="post" id="editForm">
                    <input type="hidden" name="operation" value="edit_document_filter">
                    ...
                    <div class="formcon">
                        ...
                        <div class="yuzde70">
                            <input type="text" name="name" value="<?php echo $filter["name"]; ?>">
                        </div>
                    </div>
                                    ...
                                    <?php
                                        if($filter["rules"]){
                                            foreach($filter["rules"] AS $k=>$rule){
                                                ...
                                                <div class="rule-item">
                                                    <div class="yuzde30">
                                                        <select name="rules[<?php echo $k; ?>][type]" onchange="selected_filter(this);">
                                                            <option value=""><?php echo ___("needs/select-your"); ?></option>
                                                            <?php
                                                                foreach($_rules AS $r_key => $_rule){
                                                                    ?>
                                                                    <option<?php echo $r_type == $r_key ? ' selected' : ''; ?> value="<?php echo $r_key; ?>"><?php echo $_rule; ?></option>
                                                                    <?php
                                                                }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <div class="yuzde60">
                                                        <div class="country-city-wrap" style="<?php echo $r_type == "country-city" ? '' : 'display: none;'; ?>">
                                                            <select name="rules[<?php echo $k;?>][country]" class="yuzde50 country-item" onchange="selected_country(this);" style="float:left;">
                                                                <option value=""><?php echo ___("needs/select-your"); ?></option>
                                                                <?php
                                                                    foreach($countries AS $row){
                                                                        ?>
                                                                        <option<?php echo $row["id"] == $rule["country"] ? ' selected' : ''; ?> value="<?php echo $row["id"]; ?>"><?php echo $row["name"]; ?></option>
                                                                        <?php
                                                                    }
                                                                ?>
                                                            </select>
                                                            <select name="rules[<?php echo $k; ?>][city]" class="yuzde50 city-item">
                                                                <option value=""><?php echo ___("needs/select-your"); ?></option>
                                                                <?php
                                                                    if(isset($cities[$rule["country"]]) && $cities[$rule["country"]])
                                                                    {
                                                                        foreach($cities[$rule["country"]] AS $row){
                                                                            ?>
                                                                            <option<?php echo $row["id"] == $rule["city"] ? ' selected' : ''; ?> value="<?php echo $row["id"]; ?>"><?php echo $row["name"]; ?></option>
                                                                            <?php
                                                                        }
                                                                    }
                                                                ?>
                                                        ...
                                                        <div class="age-wrap other-wrappers" style="<?php echo $r_type == "age" ? '' : 'display: none;'; ?>">
                                                            <input type="number" name="rules[<?php echo $k; ?>][age]" value="<?php echo $rule["age"]; ?>" placeholder="" style="width:50px;">
                                                            <select name="rules[<?php echo $k; ?>][age_condition]" style="width: 100px;">
                                                                <option<?php echo $rule["age_condition"] == 'up' ? ' selected' : ''; ?> value="up"><?php echo __("admin/users/document-filter-rule-age-up"); ?></option>
                                                                <option<?php echo $rule["age_condition"] == 'down' ? ' selected' : ''; ?> value="down"><?php echo __("admin/users/document-filter-rule-age-down"); ?></option>
                                                            </select>
                                                        </div>
                                                        <div class="last-login-diff-wrap other-wrappers" style="<?php echo $r_type == "last-login-diff" ? '' : 'display: none;'; ?>">
                                                            <input type="number" name="rules[<?php echo $k; ?>][day]" value="<?php echo $rule["day"]; ?>" placeholder="" style="width:50px;">
                                                        </div>
                                                        <div class="account-type-wrap other-wrappers" style="<?php echo $r_type == "account-type" ? '' : 'display: none;'; ?>">
                                                            <select name="rules[<?php echo $k; ?>][kind]" style="width: 180px;">
                                                                <option<?php echo $rule["kind"] == 'individual' ? ' selected' : ''; ?> value="individual"><?php echo __("admin/users/create-ac-type-individual"); ?></option>
                                                                <option<?php echo $rule["kind"] == 'corporate' ? ' selected' : ''; ?> value="corporate"><?php echo __("admin/users/create-ac-type-corporate"); ?></option>
                                                            </select>
                                                        </div>
                                                        <div class="ip-subnet-wrap other-wrappers" style="<?php echo $r_type == "ip-subnet" ? '' : 'display: none;'; ?>">
                                                            <input type="text" name="rules[<?php echo $k; ?>][value]" value="<?php echo $rule['value']; ?>" placeholder="<?php echo __("admin/users/document-filter-rule-ip-subnet-ex"); ?>" class="yuzde50">
                                                        </div>
                                                    </div>
                                                    <div class="yuzde5"><a href="javascript:void 0;" onclick="$(this).parent().parent().remove();" class="sbtn red"><i class="fa fa-trash"></i></a></div>
                                                </div>
                                    ...
                                    foreach($lang_list AS $lang){
                                        ...
                                        <div id="lang-<?php echo $lkey; ?>" class="tabcontent">
                                            ...
                                            <div id="<?php echo $lkey; ?>-fields_wrapper">
                                                <?php
                                                    if(isset($filter["fields"][$lkey]) && $filter["fields"][$lkey]){
                                                        foreach($filter["fields"][$lkey] AS $k => $field){
                                                            ?>
                                                            <div class="field-item">
                                                                <div class="template-field-option" style="display: none;">
                                                                    <div class="field-option-item">
                                                                        <div style="width: 98%;">
                                                                            <input type="text" name="fields[<?php echo $lkey; ?>][<?php echo $k; ?>][options][]" placeholder="<?php echo __("admin/users/document-filter-f-option-name"); ?>" class="yuzde90">
                                                                            <a class="sbtn red" href="javascript:void 0;" onclick="$(this).parent().remove();"><i class="fa fa-remove"></i></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="fieldcon">
                                                                    <div class="fieldcon2">
                                                                        <input type="text" name="fields[<?php echo $lkey; ?>][<?php echo $k; ?>][name]" value="<?php echo $field["name"]; ?>" placeholder="<?php echo Filter::html_clear(__("admin/users/document-filter-f-desc")); ?>">
                                                                    </div>
                                                                    <div class="fieldcon3">
                                                                        <select name="fields[<?php echo $lkey; ?>][<?php echo $k; ?>][type]" onchange="selected_field(this);">
                                                                            <?php
                                                                                foreach(['input','textarea','select','radio','checkbox','file'] AS $row){
                                                                                    ?>
                                                                                    <option<?php echo $field["type"] == $row ? ' selected' : ''; ?> value="<?php echo $row; ?>"><?php echo __("admin/users/document-filter-f-type-".$row); ?></option>
                                                                                    <?php
                                                                                }
                                                                            ?>
                                                                        </select>
                                                                        ...
                                                                        <div class="options-wrap other-wrappers formcon" style="<?php echo in_array($field["type"],['select','radio','checkbox']) ? '' : 'display: none;'; ?>">
                                                                            <div class="field-options-wrap">
                                                                                <?php
                                                                                    if(isset($field["options"]) && $field["options"]){
                                                                                        foreach($field["options"] AS $opt){
                                                                                            ...
                                                                                            <div class="field-option-item">
                                                                                                <div style="width: 98%;">
                                                                                                    <input type="text" name="fields[<?php echo $lkey; ?>][<?php echo $k; ?>][options][]" placeholder="<?php echo __("admin/users/document-filter-f-option-name"); ?>" class="yuzde90" value="<?php echo $opt; ?>">
                                                                                                    <a class="sbtn red" href="javascript:void 0;" onclick="$(this).parent().remove();"><i class="fa fa-remove"></i></a>
                                                                                                </div>
                                                                                            </div>
                                                                                            <?php
                                                                        ...
                                                                        <div class="file-wrap other-wrappers formcon" style="<?php echo $field["type"] == 'file' ? '' : 'display: none;'; ?>">

                                                                            <div class="formcon">
                                                                                <div class="yuzde30"><?php echo __("admin/users/document-filter-f-allowed-ext"); ?></div>
                                                                                <div class="yuzde70">
                                                                                    <input type="text" name="fields[<?php echo $lkey; ?>][<?php echo $k; ?>][allowed_ext]" placeholder="<?php echo __("admin/users/document-filter-f-allowed-ext-info"); ?>" value="<?php echo $field["allowed_ext"]; ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="formcon">
                                                                                <div class="yuzde30"><?php echo __("admin/users/document-filter-f-max-upload-fsz"); ?></div>
                                                                                <div class="yuzde70">
                                                                                    <input type="text" name="fields[<?php echo $lkey; ?>][<?php echo $k; ?>][max_file_size]" value="<?php echo $field["max_file_size"]; ?>">
                                                                                </div>
                                                                            </div>
                    ...
                    <div class="formcon">
                        ...
                        <div class="yuzde70">
                            <input<?php echo $filter["status"] == "active" ? ' checked' : ''; ?> type="checkbox" name="status" value="1" class="sitemio-checkbox" id="status">
