...
<head>
    <?php
        ...
        $pcategories    = explode(",",$page["categories"]);

        $invisibility   = $page["visibility"] == "visible" ? 0 : 1;
        $rank           = $page["rank"];
    ...
    <script type="text/javascript">
        ...
        function mockup_delete(){
            ...
            var request = MioAjax({
                action:"<?php echo $links["controller"]; ?>",
                method:"POST",
                data:{operation:"delete_page_mockup"}
            },true,true);
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/manage-website/page-references-edit",['{title}' => $page["title"]]); ?></strong></h1>
            ...
            <form action="<?php echo $links["controller"]; ?>" method="post" id="editForm" style="margin-top: 5px;">
                <input type="hidden" name="operation" value="edit_reference_page">
                ...
                <div id="tab-lang"><!-- tab wrap content start -->
                    ...
                    <?php
                        ...
                        foreach($lang_list AS $lang) {
                            ...
                            $featrddifo = isset($optionsl["featured-info"]) ? $optionsl["featured-info"] : false;
                            $techncdifo = isset($optionsl["technical-info"]) ? $optionsl["technical-info"] : false;
                            ...
                            <div id="lang-<?php echo $lkey; ?>" class="tabcontent">
                                ...
                                <div class="adminpageconxx">
                                    ...
                                    <div class="formcon">
                                        <div class="yuzde30">
                                            <?php echo __("admin/manage-website/create-featured-info"); ?>
                                            <div class="clear"></div>
                                            <br>
                                            <span class="kinfo"><?php echo __("admin/manage-website/create-featured-info-desc"); ?></span>
                                        </div>
                                        <div class="yuzde70">
                                            <textarea  name="featured-info[<?php echo $lkey; ?>]" rows="3" placeholder=""><?php echo $featrddifo; ?></textarea>
                                        </div>
                                    </div>

                                    <div class="formcon">
                                        <div class="yuzde30">
                                            <?php echo __("admin/manage-website/create-technical-info"); ?>
                                            <div class="clear"></div>
                                            <br>
                                            <span class="kinfo"><?php echo __("admin/manage-website/create-technical-info-desc"); ?></span>
                                        </div>
                                        <div class="yuzde70">
                                            <textarea  name="technical-info[<?php echo $lkey; ?>]" rows="3" placeholder=""><?php echo $techncdifo; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <?php if($lang["local"]): ?>
                                        ...
                                        <div class="formcon">
                                            <div class="yuzde30">
                                                <?php echo __("admin/manage-website/create-reference-website"); ?>
                                            </div>
                                            <div class="yuzde70">
                                                <input type="text" name="website" value="<?php echo $website; ?>">
                                                <span class="kinfo"><?php echo __("admin/manage-website/create-reference-website-desc"); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="formcon">
                                            <div class="yuzde30"><?php echo __("admin/manage-website/invisible"); ?></div>
                                            <div class="yuzde70">
                                                ...
                                                <span class="kinfo"><?php echo __("admin/manage-website/invisible-info"); ?></span>
                                        ...
                                        <div class="formcon">
                                            <div class="yuzde30"><?php echo __("admin/manage-website/create-mockup-image"); ?>
                                                <div class="clear"></div>
                                                <span class="kinfo"><?php echo __("admin/manage-website/create-mockup-image-desc"); ?></span>
                                            </div>
                                            <div class="yuzde70">
                                                <div class="headerbgedit">
