...
<head>
    ...
    <script>
        ...
        function deleteProduct(id,name){
            var content = "<?php echo __("admin/products/sms-product-delete-are-youu-sure"); ?>";
            $("#confirmModal_text").html(content.replace("{name}",name));

            open_modal("ConfirmModal",{
                title:"<?php echo __("admin/products/delete-modal-sms-product-title"); ?>"
            });
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1>
                    <strong><?php echo __("admin/products/page-sms-list"); ?></strong>
                    <a href="<?php echo $links["sms-group-redirect"]; ?>" target="_blank" class="sbtn"><i class="fa fa-external-link" aria-hidden="true"></i></a>
                </h1>
            ...
            <div style="float: right;">
                <a href="<?php echo $links["reports"]; ?>" class="lbtn"><i class="fa fa-bar-chart"></i> <?php echo __("admin/products/sms-reports"); ?></a>

                <a href="<?php echo $links["origins"]; ?>" class="lbtn"><i class="fa fa-id-card-o"></i> <?php echo __("admin/products/sms-origins"); ?></a>
            </div>
