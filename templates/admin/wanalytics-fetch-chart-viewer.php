<?php
    if(isset($filter_chart_view)){
        if($filter_chart_view == "bar" || $filter_chart_view == "striped" || $filter_chart_view == "pie"){
            ?>
            <!-- Resources -->
        ...
        elseif($filter_chart_view == "countries"){
            ?>
            <!-- Resources -->
            <script src="https://www.amcharts.com/lib/4/core.js"></script>
    ...
    if(isset($result) && $result && isset($filter_chart_view) && $filter_chart_view)
    {
        if($filter_chart_view == "bar"){
            ...
            <script type="text/javascript">
                ...
                // Add data
                chart.data = [<?php echo $values ? implode(',',$values) : ''; ?>];
        ...
        elseif($filter_chart_view == "striped"){
            ...
            foreach($result AS $k=>$v){
                $chartValues[] = [
                    'date'      => $k,
                    'value'     => is_array($v) ? number_format($v["total"],2,'.','') : $v,
                ];
            }
            ...
            <script>
                ...
                // Add data
                chart.data = <?php echo Utility::jencode($chartValues); ?>;
        ...
        elseif($filter_chart_view == "countries"){
            ...
            <script>
                ...
                var mapData = [<? echo $values ? implode(',',$values) : ''; ?>];

                // Add lat/long information to data
                for(var i = 0; i < mapData.length; i++) {
                    if(latlong[mapData[i].id] !== undefined)
                    {
        ...
        elseif($filter_chart_view == "pie"){
            ...
            <script>
                ...
                // Add data
                chart.data = <?php echo Utility::jencode($result); ?>;
