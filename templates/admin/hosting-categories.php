...
<head>
    ...
    <script>
        ...
        function deleteCategory(id,name){
            var content = "<?php echo __("admin/products/hosting-category-delete-are-youu-sure"); ?>";
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1>
                    <strong><?php echo __("admin/products/page-hosting-list"); ?> (<?php echo __("admin/products/product-categories"); ?>)</strong>
