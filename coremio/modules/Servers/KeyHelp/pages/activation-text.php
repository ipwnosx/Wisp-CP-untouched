...
?>
<?php echo $LANG["text1"]; ?>;
- Panel: <?php echo $server["name"]; ?>/
- FTP Server: <?php echo $server["name"]; ?>
...
<?php echo $LANG["text5"]; ?>
<?php echo $LANG["text6"]; ?>: mail.<?php echo $server["name"]; ?>
<?php echo $LANG["text7"]; ?>: mail.<?php echo $server["name"]; ?>
<?php echo $LANG["text8"]; ?>: 587
<?php echo $LANG["text9"]; ?>: 110
(<?php echo Utility::text_replace($LANG["text10"]["content"],['{mail_panel_link}' => "http://".$server["name"]."/webmail"]); ?>)