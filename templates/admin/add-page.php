    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/manage-website/page-pages-create"); ?></strong></h1>
            ...
            <form action="<?php echo $links["controller"]; ?>" method="post" id="addNewForm" style="margin-top: 5px;">
                <input type="hidden" name="operation" value="add_normal_page">
                                        ...
                                        <!--div class="formcon">
                                            ...
                                            <div class="yuzde70">
                                                <div class="headerbgedit">
                                                    ...
                                                    <div class="headbgeditbtn">
                                                        <a href="javascript:$('#list_image').val('').trigger('change');" class="photosil"><i class="fa fa-trash"></i></a><br/>
