...
<head>
    ...
    <script type="text/javascript">
        ...
        function change_newsletter(elem){
            var lang = $(elem).val();
            if(lang == 'none')
                $("#BulkSMSForm textarea[name=newsletter]").val('').trigger("change");
            else
                $("#BulkSMSForm textarea[name=newsletter]").val($("#newsletter_modal textarea[name='data["+lang+"]']").val()).trigger("change");
        }
        ...
        function PreviewBtn()
        {
            ...
            $("#message_output").html(nl2br($('textarea[name=message]').val()));
    ...
    <div class="padding20">
        ...
        <div class="formcon">
            ...
            <div class="yuzde70">
                ...
                <textarea name="test_cc" rows="2" placeholder="<?php echo "+12025550113\n+905555555555"; ?>"></textarea>
                            ...
                            if(solve !== false){
                                if(solve.status == "error"){
                                    ...
                                    if(solve.data != undefined && solve.data){
                                        ...
                                        if($("#newsletter-"+h_lang).prop("checked")) $("#BulkSMSForm textarea[name=newsletter]").val(data).trigger("change");
                                    }
            ...
            <div class="formcon">
                <?php
                    foreach(Bootstrap::$lang->rank_list() AS $item){
                        $key        = $item["key"];
                        $data       = isset($newsletter) && isset($newsletter[$key]["data"]) ? $newsletter[$key]["data"] : [];
                        ?>
...
<div id="ConfirmModal" data-izimodal-title="<?php echo __("admin/tools/submit-bulk-sms"); ?>" style="display: none;">
    <div class="padding20">

        <div align="center" id="show_result_wrap">
            <div style="margin: 30px 0px;" class="result_count"><?php echo __("admin/tools/filter-result-gsm",['{count}' => '<strong>0</strong>']); ?></div>

            <div class="line"></div>

            <div class="guncellebtn yuzde30">
                <a href="javascript:void(0);" id="BulkSMSForm_submit" class="gonderbtn yesilbtn"><?php echo __("admin/tools/bulk-start"); ?></a>
            </div>
...
<div id="wrapper">
    <div style="<?php echo isset($show) && $show ? '' : 'display: none;'; ?>" class="icerik-container" id="submit_wrap">
        ...
        <div class="icerik">
            ...
            <div class="adminpagecon">
                ...
                <form action="<?php echo $links["controller"]; ?>" method="post" id="BulkSMSForm">
                    <input type="hidden" name="operation" value="submit_bulk_sms">
                                ...
                                <div class="yuzde70">
                                    ...
                                    <?php
                                        foreach(Bootstrap::$lang->rank_list() AS $item){
                                            ...
                                            <label style="margin-right:5px;margin-left:5px;" class="radio-custom-label" for="newsletter-<?php echo $key; ?>"><?php echo Utility::strtoupper($key); ?> <span id="newsletter-<?php echo $key; ?>_count">(<?php echo isset($newsletter) ? $newsletter[$key]["count"] : 0; ?>)</span></label>
                    ...
                    <div class="formcon">
                        <div class="yuzde30">
                            <?php echo __("admin/tools/cc-phones"); ?>
                            <div class="clear"></div>
                            <span class="kinfo"><?php echo __("admin/tools/cc-phones-info"); ?></span>
                        </div>
                        <div class="yuzde70">
                    ...
                    <div class="formcon">
                        <div class="yuzde30"><?php echo __("admin/tools/message"); ?></div>
                        <div class="yuzde70">
                    ...
                    <div style="margin-top:10px;display: none;" class="result_count"><?php echo __("admin/tools/filter-result-gsm",['{count}' => '<strong>0</strong>']); ?></div>
                ...
                <script type="text/javascript">
                    $(document).ready(function(){
                        ...
                        $("#ConfirmModal").on("click","#BulkSMSForm_submit",function(){
                            ...
                            MioAjaxElement($(this),{
                                ...
                                waiting_text: '<?php echo ___("needs/button-waiting"); ?>',
                                progress_text: '<?php echo ___("needs/button-uploading"); ?>',
                                result:"BulkSMSForm_handler",
                            });
                        });
                    });

                    function BulkSMSForm_handler(result){
                        if(result != ''){
                            ...
                            if(solve !== false){
                                if(solve.status == "error"){
                                    template_name = '';
                                    if(solve.for != undefined && solve.for != ''){
                                        $("#BulkSMSForm "+solve.for).focus();
                                        $("#BulkSMSForm "+solve.for).attr("style","border-bottom:2px solid red; color:red;");
                                        $("#BulkSMSForm "+solve.for).change(function(){
                                            $(this).removeAttr("style");
                                        });
                                    }
                                    if(solve.message != undefined && solve.message != '')
    ...
    <div class="email-sms-campaigns" id="list_wrap" style="<?php echo  isset($show) && $show ? 'display:none;' : ''; ?>">
        ...
        <div class="icerikbaslik">
            <h1><strong><?php echo __("admin/tools/page-bulk-sms"); ?></strong></h1>
            <?php include __DIR__.DS."inc".DS."breadcrumb.php"; ?>
        </div>
