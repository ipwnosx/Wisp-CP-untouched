...
<head>
    ...
    <script>
        ...
        function deleteCategory(id,name){
            var content = "<?php echo __("admin/products/software-category-delete-are-youu-sure"); ?>";
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1>
                    <strong><?php echo __("admin/products/page-software-list"); ?> (<?php echo __("admin/products/product-categories"); ?>)</strong>
