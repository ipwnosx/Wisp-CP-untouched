    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/manage-website/page-references-create"); ?></strong></h1>
            ...
            <form action="<?php echo $links["controller"]; ?>" method="post" id="addNewForm" style="margin-top: 5px;">
                <input type="hidden" name="operation" value="add_reference_page">
                            ...
                            <div id="lang-<?php echo $lkey; ?>" class="tabcontent">
                                ...
                                <div class="adminpageconxx">
                                    ...
                                    <div class="formcon">
                                        ...
                                        <div class="yuzde70">
                                            <textarea  name="featured-info[<?php echo $lkey; ?>]" rows="3" placeholder=""></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="formcon">
                                        ...
                                        <div class="yuzde70">
                                            <textarea  name="technical-info[<?php echo $lkey; ?>]" rows="3" placeholder=""></textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="formcon">
                                            ...
                                            <div class="yuzde70">
                                                <div class="headerbgedit">
                                                    ...
                                                    <div class="headbgeditbtn">
                                                        <a href="javascript:void(0);$('#mockup_image').val('').trigger('change');" class="photosil"><i class="fa fa-trash"></i></a><br/>
