    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/products/page-edit-special-category",['{group-name}' => $group["title"],'{name}' => $cat["title"]]); ?></strong></h1>
            ...
            <form  enctype="multipart/form-data" action="<?php echo $links["controller"]; ?>" method="post" id="editForm" style="margin-top: 5px;">
                <input type="hidden" name="operation" value="edit_special_category">
                                        ...
                                        <div class="formcon">
                                            ...
                                            <div class="yuzde70">
                                                <select name="parent" size="10">
                                                    <option<?php echo $parent==$group["id"] ? ' selected' : ''; ?> value="0"><?php echo ___("needs/none"); ?></option>
                                                    <?php
